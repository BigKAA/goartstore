...
- [ ] **5.4 Верификация новых параметров**
  - **Dependencies**: 5.2
...
- [ ] Docker-образы собраны и загружены в Harbor
- [ ] Все тесты пройдены
- [ ] Поведение по умолчанию не изменилось
- [ ] План перенесён в архив
