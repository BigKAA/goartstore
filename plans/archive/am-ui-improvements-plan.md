...
- [x] **4.0 Проверка linter для AM и QM**
  - **Dependencies**: None
...
- [x] **4.1 Сборка Docker-образов AM и QM**
  - **Dependencies**: 4.0
...
- [x] **4.2 Деплой в тестовый кластер**
  - **Dependencies**: 4.1
...
- [x] **4.3 Интеграционное тестирование AM**
  - **Dependencies**: 4.2
...
- [x] **4.4 Интеграционное тестирование QM**
  - **Dependencies**: 4.2
...
- [x] Все подпункты завершены (4.0 — 4.4)
- [x] golangci-lint проходит без ошибок для AM и QM
- [x] Docker образы AM и QM собраны и запушены в Harbor
- [x] Все существующие интеграционные тесты проходят (`make test-am`, `make test-qm`)
- [x] Новые тест-кейсы для archived files проходят
