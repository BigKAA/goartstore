...
- **Последнее обновление**: 2026-02-24
- **Примечание**: Phase 2 завершена — capacity check в Upload (507), SystemHandler без diskFn, disk_usage.go удалён
...
- [x] `go build ./...` успешна
- [x] `go test ./...` проходит
- [ ] Upload файла сверх лимита возвращает 507 *(требует интеграционного тестирования — Phase 4)*
- [ ] `/api/v1/info` возвращает `total_bytes = MaxCapacity` *(требует интеграционного тестирования — Phase 4)*
